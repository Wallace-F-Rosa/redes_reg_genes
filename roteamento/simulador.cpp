...
void init_config8(config8 & config)
{
    PE[0][0] = 0; PE[1][0] = 13;
    PE[0][1] = 1; PE[1][1] = 59;
    PE[0][2] = 2; PE[0][2] = 23;
...
int main ()
{
   ...
   //gerar lista de arestas na mao e ler
	...
	bool freePE[g.nv];
    for(int i = 0; i < g.nv; i++){freePE[i]=true; PE[i] = -1;} 
	...
	for(int i = 0; i < g.na; i++)
	{
		...
		if(r) sucess++;
		else {cout << "Fail" <<endl; break;} //uma conexão não pode ser estabelecida
	}
