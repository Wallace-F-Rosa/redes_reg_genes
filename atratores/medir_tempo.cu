...
__global__ void passo_bool_Apoptosis_Network()
{
    bool v[41] = {true};
    v[0] = ( v[25] );
    v[1] = ( v[29] );
...
void passo_bool_Apoptosis_Network_cpu(unsigned long long simN)
{
    bool v[41] = {true};
...
__global__ void passo_bool_IL_6_Signaling()
{
    bool v[87] = {true};
    v[0] = ( ( v[63] ) & !( v[71] ) );
...
__global__ void passo_bool_CD4_T_cell_signaling()
{
    bool v[188]={true};
    v[0] = ( v[105] );
    v[1] = ( v[131] ) | ( v[86] ) | ( v[24] );
...
int main(int argc, char **argv)
{
    ...
    clock_t beg = clock();
    //passo_bool_Apoptosis_Network_cpu(MAX_ESTADO);
    //passo_bool_IL_6_Signaling(MAX_ESTADO);
    passo_bool_CD4_T_cell_signaling<<<grid,block>>>();
    clock_t end = clock();
