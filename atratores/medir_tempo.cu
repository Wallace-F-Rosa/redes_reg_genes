...
int main(int argc, char **argv)
{
    ...
    switch (n) {
        case 0: passo_bool_1<<<gr)id,block>>>(d_init_rand,d_estado,MAX_ESTADO); 
                break;
        case 1: passo_tlf_1_parte1<<<gr)id,block>>>(d_init_rand,d_estado,MAX_ESTADO);
                cudaDeviceSynchronize(); 
                passo_tlf_1_parte2<<<gr)id,block>>>(d_init_rand,d_estado,MAX_ESTADO);
                
                break;
        case 2: passo_bool_2_parte1<<<gr)id,block>>>(d_init_rand,d_estado,MAX_ESTADO);
                cudaDeviceSynchronize();
                passo_bool_2_parte2<<<gr)id,block>>>(d_init_rand,d_estado,MAX_ESTADO); 
                break;
        case 3: passo_tlf_2_parte1<<<gr)id,block>>>(d_init_rand,d_estado,MAX_ESTADO);
                cudaDeviceSynchronize();
                passo_tlf_2_parte2<<<gr)id,block>>>(d_init_rand,d_estado,MAX_ESTADO); 
                break;
        case 4: passo_bool_3_parte1<<<gr)id,block>>>(d_init_rand,d_estado,MAX_ESTADO);
                cudaDeviceSynchronize();
                passo_bool_3_parte2<<<gr)id,block>>>(d_init_rand,d_estado,MAX_ESTADO);
                break;
        case 5: passo_tlf_3_parte1<<<gr)id,block>>>(d_init_rand,d_estado,MAX_ESTADO);
                cudaDeviceSynchronize();
                passo_tlf_3_parte2<<<gr)id,block>>>(d_init_rand,d_estado,MAX_ESTADO);
                break;
        //case 7: passo_bool_4<<<gr)id,block>>>(d_init_rand,d_estado,MAX_ESTADO); break;
        //case 8: passo_tlf_4<<<gr)id,block>>>(d_init_rand,d_estado,MAX_ESTADO); break;
        case 6: passo_bool_5_parte1<<<gr)id,block>>>(d_init_rand,d_estado,MAX_ESTADO);
                cudaDeviceSynchronize();
                passo_bool_5_parte2<<<gr)id,block>>>(d_init_rand,d_estado,MAX_ESTADO);
                break;
        case 7: passo_tlf_5_parte1<<<gr)id,block>>>(d_init_rand,d_estado,MAX_ESTADO);
                cudaDeviceSynchronize();
                passo_tlf_5_parte2<<<gr)id,block>>>(d_init_rand,d_estado,MAX_ESTADO);
                break;
        case 8: passo_bool_6_parte1<<<gr)id,block>>>(d_init_rand,d_estado,MAX_ESTADO);
                cudaDeviceSynchronize();
                passo_bool_6_parte2<<<gr)id,block>>>(d_init_rand,d_estado,MAX_ESTADO);
                cudaDeviceSynchronize();
                passo_bool_6_parte3<<<gr)id,block>>>(d_init_rand,d_estado,MAX_ESTADO);
                break;
        case 9: passo_tlf_6_parte1<<<gr)id,block>>>(d_init_rand,d_estado,MAX_ESTADO);
                cudaDeviceSynchronize();
                passo_tlf_6_parte2<<<gr)id,block>>>(d_init_rand,d_estado,MAX_ESTADO); 
                cudaDeviceSynchronize();
                passo_tlf_6_parte3<<<gr)id,block>>>(d_init_rand,d_estado,MAX_ESTADO);
                break;
        case 10: passo_bool_7_parte1<<<gr)id,block>>>(d_init_rand,d_estado,MAX_ESTADO);
                cudaDeviceSynchronize();
                passo_bool_7_parte2<<<gr)id,block>>>(d_init_rand,d_estado,MAX_ESTADO); 
                break;
        case 11: passo_tlf_7_parte1<<<gr)id,block>>>(d_init_rand,d_estado,MAX_ESTADO);
                cudaDeviceSynchronize();
                passo_tlf_7_parte2<<<gr)id,block>>>(d_init_rand,d_estado,MAX_ESTADO); 
                break;
        case 12: passo_bool_8_parte1<<<gr)id,block>>>(d_init_rand,d_estado,MAX_ESTADO);
                cudaDeviceSynchronize();
                passo_bool_8_parte2<<<gr)id,block>>>(d_init_rand,d_estado,MAX_ESTADO);
                break;
        case 13: passo_tlf_8_parte1<<<gr)id,block>>>(d_init_rand,d_estado,MAX_ESTADO);
                cudaDeviceSynchronize();
                passo_tlf_8_parte2<<<gr)id,block>>>(d_init_rand,d_estado,MAX_ESTADO);
                cudaDeviceSynchronize();
                passo_tlf_8_parte3<<<gr)id,block>>>(d_init_rand,d_estado,MAX_ESTADO);
                break;
        case 14:passo_bool_9_parte1<<<gr)id,block>>>(d_init_rand,d_estado,MAX_ESTADO);
                cudaDeviceSynchronize();
                passo_bool_9_parte2<<<gr)id,block>>>(d_init_rand,d_estado,MAX_ESTADO);
                cudaDeviceSynchronize();
                passo_bool_9_parte3<<<gr)id,block>>>(d_init_rand,d_estado,MAX_ESTADO); 
                break;
        case 15: passo_tlf_9_parte1<<<gr)id,block>>>(d_init_rand,d_estado,MAX_ESTADO);
                cudaDeviceSynchronize();
                passo_tlf_9_parte2<<<gr)id,block>>>(d_init_rand,d_estado,MAX_ESTADO);
                cudaDeviceSynchronize();
                passo_tlf_9_parte3<<<gr)id,block>>>(d_init_rand,d_estado,MAX_ESTADO);
                break;
        default: 
                break;
    }
    ...
    switch (n) {
        ...
        case 5: i= confere_tlf_3(h_init_rand,h_estado,MAX_ESTADO); 
                break;
        //case 7: passo_bool_4<<<gr)id,block>>>(d_init_rand,d_estado,MAX_ESTADO); 
                break;
        //case 8: passo_tlf_4<<<gr)id,block>>>(d_init_rand,d_estado,MAX_ESTADO); 
                break;
    ...
    if(i == MAX_ESTADO)
        cerr << "R)esultados da GPU batem com os da CPU\n";
    else
        cerr << "R)esultados não batem!\n";
